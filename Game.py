...
Original file is located at
    https://colab.research.google.com/drive/1IMoCXT_QQuk2pIYlhLZAblZmXUGBcNqh
"""
...
class game:
    ...
    '''
    def __init__(self,standard=True,x_dim=25,y_dim=25,O_prob=0.2,Food_number=15,Enemy_number=4,I_pos=(19,13),Energy_units=40, reinforcement_natural_death = -1, food_pos=None):
        self.x_dim=x_dim
        self.y_dim=y_dim
        self.O_prob=O_prob
    ...
    def restart(self,standard=True,x_dim=25,y_dim=25,O_prob=0.2,Food_number=15,Enemy_number=4,I_pos=(19,13),Energy_units=40, food_pos=None):#restarts the board into standard setup.
        self.__init__(standard,x_dim,y_dim,O_prob,Food_number,Enemy_number,I_pos,Energy_units,self.reinforcement_natural_death,food_pos)
